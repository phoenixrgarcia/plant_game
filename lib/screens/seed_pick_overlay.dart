/* This file has been commented out and deprecated because of the changes to the seed shop
Instead of choosing which seed you want from a choice of three, you now are given a random seed 
of a random rarity*/
...
//       child: SeedPickDialog(
//           options: filled.take(3).toList(), onSelected: onSelected),
//     ),
//   );
// }
...
//             Text('Pick one of the three plants below to grow in your garden.',
...
//                             // stats
//                             _StatsList(
//                                 stats: item['stats'] as Map<String, dynamic>),
//                           ],
//                         ),
//                       ),
//                     ),
...
//                     // GameStateManager().addToInventory(chosen); // this is commented out because of tthe addToInventory change
